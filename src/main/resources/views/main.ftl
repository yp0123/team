        ...
        <div class="layui-side-scroll layui-left-menu">
                <ul class="layui-nav layui-nav-tree layui-left-nav-tree layui-this" id="currency">
                        <li class="layui-nav-item">
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-3" data-tab="sf" target="_self"><i class="fa fa-exchange"></i><span class="layui-left-nav"> 订单管理</span></a>
                        </li>
                        <li class="layui-nav-item">
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-3" data-tab="sfwr" target="_self"><i class="fa fa-exchange"></i><span class="layui-left-nav"> 房价类型</span></a>
                        </li>
                        <li class="layui-nav-item">
